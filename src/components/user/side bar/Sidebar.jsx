                ...
                <div id="sidebar__inner" class="flex sside md:flex-col justify-between md:h-screen md:p-2 p-1 transition-all duration-500 bg-white shadow dark:bg-dark2 2xl:w-72 xl:w-60 max-xl:w-[73px] max-md:w-screen max-md:border-t max-md:dark:border-slate-700">
                    ...
                    <div className="flex h-20 px-2 max-md:fixed max-md:top-0 max-md:w-full max-md:bg-white/80 max-md:left-0 max-md:px-4 max-md:h-14 max-md:shadow-sm max-md:dark:bg-slate-900/80 backdrop-blur-xl">
                        <div className="w-full flex items-center justify-center gap-3">
                            ...
                            <img src="../../../../public/images/logo.png" alt="" className="w-max  h-6 ml-1 hidden max-md:flex dark:!hidden" />
                        </div>
                    </div>



                    <nav class="flex-1 max-md:flex max-md:justify-around max-md:item-end md:space-y-2">
                        ...
                        {showSearch == true ?
                            <div class="sm:w-[397px] w-full bg-white shadow-lg md:!left-[73px] absolute top-0 !left-0 dark:bg-dark2 dark:border1 max-md:bottom-[57px]">
